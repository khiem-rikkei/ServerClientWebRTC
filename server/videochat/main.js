document.addEventListener('DOMContentLoaded', function () {
  ...
  var getLocalStream = function (successCb) {
    if (localStream && successCb) {
      ...
      // var getMultiMedia = navigator.getUserMedia || navigator.webkitGetUserMedia || navigator.mozGetUserMedia;
  ...
  var connect = function () {
    ...
    try {
      ...
      peer = new Peer(callerId, {host: SERVER_IP, port: SERVER_PORT, path: '/api'});
